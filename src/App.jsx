...
export default function App(){
  ...
  const tenantIntegrityCollections = useMemo(() => ({
    clientes,
    producciones,
    programas,
    piezas,
  ...
  const tenantIntegritySetters = useMemo(() => ({
    clientes: setClientes,
    producciones: setProducciones,
    programas: setProgramas,
    piezas: setPiezas,
    ...
    setTreasuryPayables,
    setTreasuryPurchaseOrders,
    setTreasuryIssuedOrders,
    setTreasuryReceipts,
    setTreasuryDisbursements,
  ]);
  const tenantIntegrityLoadingMap = useMemo(() => ({
    clientes: ldCli,
    producciones: ldPro,
    programas: ldPg,
    piezas: ldPiezas,
    ...
    ldTreasuryProviders,
    ldTreasuryPayables,
    ldTreasuryPurchaseOrders,
    ldTreasuryIssuedOrders,
    ldTreasuryReceipts,
    ldTreasuryDisbursements,
  ]);
  ...
  useLabBootGuards({
    ...
    uid,
    tenantCollections: tenantIntegrityCollections,
    tenantSetters: tenantIntegritySetters,
    tenantLoadingMap: tenantIntegrityLoadingMap,
  });
