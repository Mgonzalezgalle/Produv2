...
function ViewProDet({id,empresa,clientes,producciones,contratos,movimientos,crew,eventos,navTo,openM,canDo:_cd,cSave,cDel,saveMov,delMov,setProducciones,setMovimientos}){
  ...
  return <div>
    ...
    {tab===3&&<CrewTab crew={crew||[]} empId={empId} asignados={p.crewIds||[]} onAdd={addCrew} onRem={remCrew} canEdit={_cd&&_cd("producciones")} onHonorario={m=>{openM("mov",{eid:id,et:"pro",tipo:"gasto",cat:"Honorarios",desc:"Honorarios "+m.nom,monto:m.tarifa,fecha:today()});}}/>}
...
function ViewPgDet({id,empresa,clientes,programas,episodios,auspiciadores,movimientos,crew,eventos,navTo,openM,canDo:_cd,cSave,cDel,saveMov,delMov,setProgramas,setEpisodios,setMovimientos}){
  ...
  return <div>
    ...
    {tab===4&&<CrewTab crew={crew||[]} empId={empId} asignados={pg_.crewIds||[]} onAdd={addCrew} onRem={remCrew} canEdit={_cd&&_cd("programas")} onHonorario={m=>{openM("mov",{eid:id,et:"pg",tipo:"gasto",cat:"Honorarios",desc:"Honorarios "+m.nom,monto:m.tarifa,fecha:today()});}}/>}
