...
export function AdminPanel(rawProps) {
  ...
  const {
    ...
    empUsers, filteredUsers, activeUsers, inactiveUsers, operationalHealth, criticalAuditEntries, operationalAuditEntries, ADMIN_TABS, ADMIN_TAB_META,
    activeAdminTab, editableRoleOptions, canManageAdmin, platformSnapshot, platformLoading, platformPlanning, platformPreparingMemberships, platformQueueingMemberships, remoteBsaleSnapshot, remoteProvisionedModules, bsaleGovernanceMode, tenantCanEditBsaleConfig, tenantBsaleConfig, mercadoPagoGovernanceMode, tenantCanEditMercadoPagoConfig, diioGovernanceMode, tenantDiioEnabled, tenantCanEditDiioConfig, tenantMercadoPagoConfig, setTenantMercadoPagoConfig, tenantMercadoPagoSaving, tenantDiioConfig, setTenantDiioConfig, tenantDiioSaving, tenantDiioTesting, tenantDiioImporting, resetAccess, saveUser, toggleUserActive, deleteUser, planIdentityPromotions, refreshPlatformSnapshot, prepareIdentityMembershipBlueprints, prepareMembershipTransitionQueue, saveTenantMercadoPagoConfig, saveTenantDiioConfig, verifyTenantDiioConnection, importTenantDiioMeetings,
