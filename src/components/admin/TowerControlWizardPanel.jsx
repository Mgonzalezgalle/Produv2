...
export function WizardAdminPanel({ dbGet, dbSet }) {
  ...
  return <div>
    <Card title="Wizard comercial" sub="Pricing y narrativa pública del self-serve">
      ...
      <div style={{ padding: "12px 14px", borderRadius: 14, border: "1px solid var(--bdr2)", background: "var(--sur)", marginBottom: 14, boxShadow: "0 8px 18px rgba(15,23,42,.04)" }}>
        ...
        <div style={{ display: "grid", gap: 10 }}>
          {addonCatalog.map((addon) => (
            <div key={addon.code} style={{ padding: "12px 12px 10px", borderRadius: 14, border: "1px solid var(--bdr2)", background: "var(--sur)" }}>
