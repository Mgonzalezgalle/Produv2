  ...
  return <><div className="login-shell" style={{minHeight:"100vh",background:"var(--bg)",display:"flex",alignItems:"center",justifyContent:"center",padding:20,position:"relative",overflow:"hidden"}}>
    ...
    <div className="login-card" style={{position:"relative",width:"min(1040px,100%)",display:"grid",gridTemplateColumns:"1.05fr .95fr",gap:18}}>
      ...
      <div className="login-logo" style={{textAlign:"center",marginBottom:32}}>
        ...
        <div className="login-subcopy" style={{fontSize:12,color:"#66748d",textAlign:"center",marginBottom:20}}>Este usuario está asociado a más de una empresa.</div>
...
export function EmpresaSelector({ empresas, onSelect, onSelectSuperAdmin, BrandLockup, ini, allowSuperAdmin = true }) {
  ...
  return <div className="company-shell" style={{minHeight:"100vh",background:"var(--bg)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:20}}>
    ...
    <div className="company-card" style={{position:"relative",width:"min(520px,100%)",background:"#fff",border:"1px solid var(--bdr2)",borderRadius:28,padding:22,boxShadow:"0 28px 80px rgba(15,23,42,.12)"}}>
      ...
      {allowSuperAdmin && <div style={{marginTop:12,padding:"14px 16px",background:"#f8fbff",border:"1px solid var(--bdr)",borderRadius:18,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
