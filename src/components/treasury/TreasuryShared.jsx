...
export function ContactActionButton({ tone = "mail", label, onClick }) {
  ...
  return (
    <button
      ...
      style={{ display:"inline-flex", alignItems:"center", gap:6, padding:"8px 12px", borderRadius:10, border:isWhatsApp ? "1px solid #25D36640" : "1px solid var(--cm)", background:isWhatsApp ? "#25D36618" : "var(--cg)", color:isWhatsApp ? "#25D366" : "var(--cy)", cursor:"pointer", fontSize:12, fontWeight:700 }}
    >
      {isWhatsApp ? (
