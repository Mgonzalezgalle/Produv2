...
export function IssuedOrdersTable({ rows = [], onEdit, onDelete, onSupplierEmail, onOpenDetail, selectedIds = [], toggleSelected, toggleAll, pageIds = [] }) {
