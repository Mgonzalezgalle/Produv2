...
export function normalizeDiioInteractionRecord(record = {}) {
  return {
    ...
    analyzedStatus: record.analyzedStatus || record.analyzed_status || "",
    errorCause: record.errorCause || record.error_cause || "",
    duration: Number(record.duration || 0),
    integrationType: record.integrationType || record.integration_type || "",
