...
export const INTEGRATION_REGISTRY = [
  ...
  },
  {
    ...
    name: "Mercado Pago Cobranza",
    domain: INTEGRATION_DOMAIN.PAYMENTS,
    provider: "mercadopago",
    stage: INTEGRATION_STAGE.DESIGN,
    modes: [INTEGRATION_MODE.OAUTH, INTEGRATION_MODE.HOSTED_CHECKOUT, INTEGRATION_MODE.API, INTEGRATION_MODE.WEBHOOK],
    capabilities: [
      INTEGRATION_CAPABILITY.CHECKOUT,
      INTEGRATION_CAPABILITY.PAYMENT_LINKS,
      INTEGRATION_CAPABILITY.PAYMENT_RECONCILIATION,
      INTEGRATION_CAPABILITY.INBOUND_WEBHOOKS,
    ],
    owner: "finance_platform",
    priority: 98,
    notes: "Cobranza integrada por factura para tenants con cuenta propia de Mercado Pago y conciliación en Tesorería solo contra pagos aprobados.",
    dependencies: ["invoice_payment_link_contract", "tenant_payment_connection_state", "server_side_payment_webhook", "treasury_reconciliation_guardrails"],
