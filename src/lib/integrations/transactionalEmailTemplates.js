...
export const TRANSACTIONAL_EMAIL_TEMPLATE_DEFINITIONS = [
  ...
  },
  {
    ...
    label: "Acceso portal de contenido",
    description: "Correo para compartir acceso al portal de contenido con un cliente.",
    defaultSubject: "Tu acceso al portal de contenido de {{companyName}}",
    defaultBody: [
      "Hola {{contactName}},",
      "",
      "Ya dejamos listo tu acceso al portal de contenido de {{companyName}}.",
      "",
      "Desde ahí podrás revisar avances, responder piezas y seguir el trabajo compartido.",
      "",
      "Enlace de acceso: {{portalUrl}}",
      "Código: {{accessCode}}",
      "",
      "Si necesitas apoyo para entrar o revisar algo puntual, quedamos atentos.",
      "",
      "Saludos cordiales,",
      "{{companyName}}",
    ].join("\n"),
  ...
  {
    key: "client_finance_portal_access",
    label: "Acceso portal financiero cliente",
    description: "Correo para compartir acceso al portal financiero de un cliente.",
    defaultSubject: "Tu acceso al portal financiero de {{companyName}}",
    defaultBody: [
      "Hola {{contactName}},",
      "",
      "Ya dejamos habilitado tu acceso al portal financiero de {{companyName}}.",
      "",
      "Desde este portal podrás revisar documentos, pagos, presupuestos y órdenes de compra asociadas a tu cuenta.",
      "",
      "Enlace de acceso: {{portalUrl}}",
      "Código: {{accessCode}}",
      "",
      "Si tu documento tiene link activo, también podrás pagar en línea desde el mismo portal.",
      "",
      "Saludos cordiales,",
      "{{companyName}}",
    ].join("\n"),
  ...
  {
    key: "provider_finance_portal_access",
    label: "Acceso portal financiero proveedor",
    description: "Correo para compartir acceso al portal financiero de un proveedor.",
    defaultSubject: "Tu acceso al portal financiero de {{companyName}}",
    defaultBody: [
      "Hola {{contactName}},",
      "",
      "Ya dejamos habilitado tu acceso al portal financiero de {{companyName}}.",
      "",
      "Desde este portal podrás revisar documentos, pagos registrados, órdenes de compra emitidas e información de pago visible para tu cuenta.",
      "",
      "Enlace de acceso: {{portalUrl}}",
      "Código: {{accessCode}}",
      "",
      "Si necesitas apoyo para ingresar o validar información, quedamos atentos.",
      "",
      "Saludos cordiales,",
      "{{companyName}}",
    ].join("\n"),
  },
  {
    ...
    defaultSubject: "Estado de cuenta vigente · {{supplierName}}",
    defaultBody: [
      "Hola {{contactName}},",
      "",
      ...
      "",
      "Si necesitas revisar algún documento en particular o coordinar su regularización, quedamos atentos.",
      "",
      "Saludos cordiales,",
      "{{companyName}}",
    ].join("\n"),
